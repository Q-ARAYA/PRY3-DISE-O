      ...
      <div className="footer-container">
        ...
        <div className="footer-payment">
          ...
          <div className="payment-methods" aria-label="Métodos de pago aceptados">
            <span className="payment-icon" aria-label="Visa">💳 VISA</span>
            <span className="payment-icon" aria-label="Mastercard">💳 MC</span>
            <span className="payment-icon" aria-label="PayPal">💰 PayPal</span>
            <span className="payment-icon" aria-label="American Express">💳 AMEX</span>
          </div>
        </div>

        {/* Bottom */}
        <div className="footer-bottom">
          <p>&copy; 2025 FlashMarket. Todos los derechos reservados.</p>
